...
CREATE TABLE IF NOT EXISTS `tbl_songs` (
  ...
  `song_age_rating` varchar(50) NOT NULL,
  PRIMARY KEY (`song_id`)
...
INSERT INTO `tbl_songs` (`song_id`, `song_name`, `song_artist`, `song_cover_art`, `song_file`, `song_year`, `song_genre`, `song_age_rating`) VALUES
(1, 'I Walk The Line', 'Johnny Cash', 'i_walk_the_line.jpg', 'i_walk_the_line.mp3', 1956, 'Country', 'Clean'),
(2, 'Johnny B. Goode', 'Chuck Berry', 'johnny_b_goode.jpg', 'johnny_b_goode.mp3', 1958, 'Rock', 'Clean'),
(3, 'Hit the Road Jack', 'Ray Charles', 'hit_the_road_jack.jpg', 'hit_the_road_jack.mp3', 1961, 'R&B', 'Clean'),
(4, 'Fortunate Son', 'Creedence Clearwater Revival', 'fortunate_son.jpg', 'fortunate_son.mp3', 1969, 'Rock', 'Clean'),
(5, 'Cat\'s in the Cradle', 'Harry Chapin', 'cats_in_the_cradle.jpg', 'cats_in_the_cradle.mp3', 1974, 'Folk Rock', 'Clean'),
(11, 'Ain\'t Talkin\' \'bout Love', 'Van Halen', 'aint_talkin_bout_love.jpg', 'aint_talkin_bout_love.mp3', 1978, 'Hard Rock', 'Parental Advisory'),
(12, 'Rock Box', 'Run-DMC', 'rock_box.jpg', 'rock_box.mp3', 1984, 'Rap', 'Parental Advisory'),
(13, 'I Ran (So Far Away)', 'Flock of Seagulls', 'i_ran.jpg', 'i_ran.mp3', 1982, 'New Wave', 'Clean'),
(14, 'C.R.E.A.M.', 'Wu-Tang Clan', 'cream.jpg', 'cream.mp3', 1993, 'Rap', 'Parental Advisory'),
(15, 'Song 2', 'Blur', 'song_2.jpg', 'song_2.mp3', 1997, 'Alt Rock', 'Clean');
...
(2, 3, 'user3.png', 'Scott', 1, 0, 1, 1),
(3, 3, 'user4.png', 'Mike', 0, 0, 1, 0),
(4, 4, 'user2.png', 'Trevor', 0, 0, 1, 0),
(5, 3, 'user6.png', 'Phil', 0, 0, 1, 0),
(10, 3, 'user1.png', 'Greg', 1, 0, 6, 1),
